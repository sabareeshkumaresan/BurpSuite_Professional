# Name is Important
echo "
BurpSuite Professional Installation Setup
"
...
#creating startmenu burp file

Copy-Item 'C:\burp\Burp Suite Professional.lnk' -Destination "C:\ProgramData\Microsoft\Windows\Start Menu\Programs\"
